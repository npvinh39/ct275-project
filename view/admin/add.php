...
$tour->fill($_POST);
if ($tour->validate()) {
$tour->save() && redirect(BASE_URL_PATH);
}
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center">
						<p class="wow fadeIn" data-wow-duration="2s">Thêm điểm vào form bên dưới.</p>
					</div>
				</div>
					...
					<div class="col-md-12">
						...
						<form name="frm" id="frm" action="" method="post" class="col-md-6 col-md-offset-3">
							...
							<div class="form-group<?= isset($errors['tour_name']) ? ' has-error' : '' ?>">
								...
								<input type="text" name="tour_name" class="form-control" maxlen="255" id="tour_name" placeholder="Nhập vào Name" value="<?= isset($_POST['tour_name']) ? htmlspecialchars($_POST['tour_name']) : '' ?>" />
							...
							<div class="form-group<?= isset($errors['tour_title']) ? ' has-error' : '' ?>">
								...
								<textarea name="tour_title" id="tour_title" class="form-control" placeholder="Nhập vào tour_title (maximum character limit: 255)"><?= isset($_POST['tour_title']) ? htmlspecialchars($_POST['tour_title']) : '' ?></textarea>
							...
							<div class="form-group<?= isset($errors['tour_description']) ? ' has-error' : '' ?>">
								...
								<textarea name="tour_description" id="tour_description" class="form-control" placeholder="Nhập vào tour_description (maximum character limit: 255)"><?= isset($_POST['tour_description']) ? htmlspecialchars($_POST['tour_description']) : '' ?></textarea>
							...
							<div class="form-group<?= isset($errors['tour_map']) ? ' has-error' : '' ?>">
								...
								<textarea name="tour_map" id="tour_map" class="form-control" placeholder="Nhập vào tour_map (maximum character limit: 255)"><?= isset($_POST['tour_map']) ? htmlspecialchars($_POST['tour_map']) : '' ?></textarea>
							...
							<div class="form-group<?= isset($errors['tour_image']) ? ' has-error' : '' ?>">
								...
								<textarea name="tour_image" id="tour_image" class="form-control" placeholder="Nhập vào tour_image (maximum character limit: 255)"><?= isset($_POST['tour_image']) ? htmlspecialchars($_POST['tour_image']) : '' ?></textarea>
							...
							<!-- Submit -->
							<button type="submit" name="submit" id="submit" class="btn btn-primary">Thêm Địa Điểm</button>
						</form>
