<form class="login100-form validate-form"  method="POST" action="../../../controller/handleLogin.php">
  ...
  <div class="wrap-input100 validate-input m-b-16" data-validate="Password is required"> <input class="input100" type="password" name="password" placeholder="Mật Khẩu"> <span class="focus-input100"></span> <span class="symbol-input100"> <span class="glyphicon glyphicon-lock"></span> </span> </div>
  ...
  <div class="container-login100-form-btn p-t-25"> <button class="login100-form-btn" type="submit" name="submit"> Đăng Nhập </button> </div>
</form>