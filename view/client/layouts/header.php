                ...
                <div class="collapse navbar-collapse justify-content-between" id="navcol-1">
                  <div class="none"></div>
                    <ul class="nav navbar-nav">
                        <li class="nav-item" role="presentation"><a class="nav-link" href="./public/client/view/product-list.html">Tour</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="#">Về chúng tôi</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="./public/client/view/contact.html">Liên hệ</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" href="./public/client/view/faq.html">FAQ</a></li>
                    ...
                    <div>
                      <span class="navbar-text"> <a class="login text-dark" href="./public/client/view/login.html">Đăng nhập</a></span>
                      <a class="btn btn-primary action-button" role="button" href="./public/client/view/register.html">Đăng ký</a>
                    </div>
                  </div>
            </div>
        </nav>